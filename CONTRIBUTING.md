...
If unique, [open an issue](https://github.com/gomematic/homebrew-gomematic/issues) and answer the questions so we can understand and reproduce the problematic behavior.
